...
class Places extends Model
{
   ...
   {
   		return $this->hasMany(PlacesCoverImages::class, 'places_id', 'id')->select(array('id', 'places_id','storageUrl'));
   }

   public function place_gallary_img()
   {
   		return $this->hasMany(PlacesGalleryImages::class, 'places_id', 'id');
   }
   ...
   {
         return $this->hasMany(OpeningHours::class, 'places_id', 'id');
   }
}
