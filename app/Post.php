...
class Post extends Model
{
	...
	{
		return $this->belongsTo(UserFirebase::class, 'user_id', 'id')->select(array('id', 'email','full_name'));
	}

	public function post_picture()
    {
    	return $this->hasMany(PostAttachment::class, 'post_id', 'id')->select(array('id', 'post_id','user_id', 'storageUrl'));
    }
